...
# gdrant
GDRANT_HOST = os.getenv("GDRANT_HOST", "localhost")
GDRANT_PORT = int(os.getenv("GDRANT_PORT", 6333))


def deleteVectorDB(DBName):
    conn = http.client.HTTPConnection(GDRANT_HOST, GDRANT_PORT)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python text2gdrant.py filepath")
        sys.exit(1)
